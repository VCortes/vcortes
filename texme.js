!(function () {
    ...
    (m.viewer = m.plain + m.viewer),
        (r.tokenize = function (e) {
            ...
            let a = 0;
            for (; null !== (o = t.exec(e)); )
                o.index > a && ((d = e.substring(a, o.index)), i.push([r.tokenType.MARK, d])),
                    void 0 !== o[1] && o[1].startsWith('md')
                        ? i.push([r.tokenType.MARK, o[2]])
                        : i.push([r.tokenType.MASK, o[0]]),
                    (a = t.lastIndex);
            return (d = e.substring(a)), e.length > a && i.push([r.tokenType.MARK, d]), i;
        }),
        (r.mask = function (e) {
            const n = [],
                t = [];
            ...
            for (i = 0; i < e.length; i++)
                (o = e[i][0]),
                    (d = e[i][1]),
                    o === r.tokenType.MARK ? n.push(d) : (n.push(r.tokenLiteral.MASK), t.push(d));
            return { text: n.join(''), tokenValues: t };
        }),
        ...
        (r.render = function (e) {
            return a.protectMath ? r.protectMathAndRenderMarkdown(e) : r.renderMarkdown(e);
        }),
        (r.renderPage = function () {
            ...
            0 < e.length
                ...
                : ((t = window.document.body.innerHTML.trim()),
            ...
            var d = m[a.style];
            o.appendChild(window.document.createTextNode(d)), window.document.head.appendChild(o);
            ...
            (i.name = 'viewport'),
                ...
                a.useMathJax && window.MathJax.typesetPromise(),
